...
export async function pkceSignIn(httpBase: string, clientId: string) {
...
export async function handleCallback(httpBase: string, log: (msg: string) => void) {
...
export async function refreshTokensFromServer(httpBase: string, log: (msg: string) => void): Promise<boolean> {
    if (!refreshToken) {
